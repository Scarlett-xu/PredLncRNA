...
def My_model_train(lncRNA_file, pcts_file):
    os.system("python /home/ls1/Extract_features/GetAllFeatures.py --longs "+lncRNA_file +
              " --pcts "+pcts_file)
    os.system("python /home/ls1/Extract_features/get_features.py")
...
def My_model_test(lncRNA_file):
    ...
    os.system(
        "python /home/ls1/Extract_features/GetAllFeatures.py --predict "+lncRNA_file)
    os.system(
        "python /home/ls1/Extract_features/get_features.py --file "+lncRNA_file)
...
def CPC2_model_train(lncRNA_file, pcts_file, output_file):
    os.system("python2 /mnt/dzk/lncRNA_prediction_tools/CPC2/bin/CPC2_train.py -l " +
              lncRNA_file+" -p "+pcts_file+" -o "+output_file)


def CPC2_model_test(lncRNA_file, output_file):
    print("CPC2 is Running ... ")
    os.system("python2 /mnt/dzk/lncRNA_prediction_tools/CPC2/bin/CPC2.py -i " +
              lncRNA_file+" -o "+output_file)
...
def CPAT_model_train(lncRNA_file, pcts_file, species):
    os.system("python2 /home/ls1/CPAT-1.2.4/bin/make_hexamer_tab.py -c " +
              pcts_file+" -n "+lncRNA_file+" > Human_Hexamer.tsv")
    os.system("python2 /home/ls1/CPAT-1.2.4/bin/make_logitModel.py  -x Human_Hexamer.tsv -c " +
              pcts_file+" -n "+lncRNA_file+" -o "+species)


def CPAT_model_test(lncRNA_file, species, output_file):
    print("CPAT is Running ... ")
    os.system("python2 /home/ls1/CPAT-1.2.4/bin/cpat.py -g "+lncRNA_file +
              " -d "+species+".logit.RData -x "+species+"_Hexamer.tsv -o "+output_file)
    result = pd.read_csv(output_file, sep="\t")
...
def CPPred_model_train(lncRNA_file, pcts_file, species):
    ...
    os.system("python2 /home/ls1/CPPred/make_hexamer_tab.py -c " +
              pcts_file+" -n "+lncRNA_file+" > test_Hexamer.tsv")
    print("Extracting features...")
    os.system("python2 /home/ls1/CPPred/CPPred_train_predict/bin/get_features_svm.py -ip " +
              pcts_file+" -in "+lncRNA_file+" -hex test_Hexamer.tsv -spe "+species+" -osvm test_features.fa")
...
def CPPred_model_test(lncRNA_file, output_file):
    ...
    os.system("python2 /home/ls1/CPPred/bin/CPPred.py -i "+lncRNA_file +
              " -hex /home/ls1/CPPred/CPPred_train_predict/bin/test_Hexamer.tsv -r /home/ls1/CPPred/CPPred_train_predict/bin/test.range -mol /home/ls1/CPPred/CPPred_train_predict/bin/test.model -spe Human -o "+output_file)
    result = pd.read_csv(output_file, sep="\t")
...
def PLEK_model_train(lncRNA_file, pcts_file):
    os.system("python2 /home/ls1/PLEK.1.2/PLEKModelling.py -mRNA " +
              pcts_file+" -lncRNA "+lncRNA_file+" -prefix plek")
...
def COME_model_test(lncRNA_file, output_file):
    print("CPPred is Running ... ")
    os.system("python2 /home/ls1/CPPred/bin/CPPred.py -i "+lncRNA_file +
              " -hex /home/ls1/CPPred/Hexamer/Human_Hexamer.tsv -r /home/ls1/CPPred/Human_Model/Human.range -mol /home/ls1/CPPred/Human_Model/Human.model -spe Human -o "+output_file)
    time.sleep(10)
    result = pd.read_csv(output_file, sep="\t")
    proba = list(1 - result['coding_potential'])
    label = list(result['table'].apply(lambda x: 0 if x == "coding" else 1))
...
def Longdist_model_train(lncRNA_file, pcts_file):
    os.system("python /home/ls1/longdist.py/longdist.py --longs "+lncRNA_file +
              " --pcts "+pcts_file+" --purge --processes 8")


def Longdist_model_test(lncRNA_file, train_X_lncRNA_path, train_X_pcts_path, outfile):
    model_config = "/home/ls1/test/mid/" + os.path.split(train_X_lncRNA_path)[1].split(
        ".")[0] + "_x_" + os.path.split(train_X_pcts_path)[1].split(".")[0] + "_50_orf1.plk.conf"
    print(model_config)
    print("Longdist is Running ... ")
    os.system("python longdist.py/longdist.py --predict --input " +
              lncRNA_file+" --model_config "+model_config+" --out "+outfile)
    print("finish!")
...
def crossValidation(all_X, global_y, folds):
    ...
    for global_train_index, global_test_index in folds.split(all_X, global_y):
        ...
        # train
        # CPC2_model_train(train_X_lncRNA_path, train_X_pcts_path,"/mnt/dzk/lncRNA_prediction_tools/cv_test/yes")
        ...
        # proba, label = CPC2_model_test(path, "/mnt/dzk/lncRNA_prediction_tools/cv_test/result/CPC2_result")
